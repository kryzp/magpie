...
internal void MemoryArenaPopTo(MemoryArena *arena, u64 pos)
{
	arena->used = pos;
}
...
internal void MemoryArenaZero(MemoryArena *arena)
{
...
internal String8 MemoryArenaAllocateString8Copy(MemoryArena *arena,
						String8 string)
{
