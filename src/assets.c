...
internal u32 AssetsTryFetchAssimpMaterialTexture(Assets *assets,
						 String8 directory,
...
internal void AssetsProcessSubModel(Assets *assets,
				    SubModel *sub_model,
				    String8 path,
...
internal void AssetsProcessModelNodes(Assets *assets,
				      Model *model,
				      String8 path,
				      struct aiNode *node,
				      const struct aiScene *scene,
...
internal u32 AssetsLoadModel(Assets *assets, String8 path)
{
	...
	AssetsProcessModelNodes(assets,
