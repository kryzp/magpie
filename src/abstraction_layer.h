...
internal float V3MaxValue(v3 v)
{
	return MaxValue(v.x, MaxValue(v.y, v.z));
}

internal float V3MinValue(v3 v)
{
...
internal v2i V2IInit(i32 x, i32 y)
{
	v2i v = { x, y };
	return v;
}
...
internal v3 M4MultiplyV3(m4 m, v3 v)
{
...
internal String8 String8BeforeFirstSubstringFromBackInclusive(String8 string,
							      String8 substring)
{
