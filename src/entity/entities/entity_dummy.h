...
internal void ENT_DummyPreAnimTick     (ENT_Dummy *dummy, const ENT_TickContext *ctx);
internal void ENT_DummyPostAnimTick    (ENT_Dummy *dummy, const ENT_TickContext *ctx);
internal void ENT_DummyPostPhysicsTick (ENT_Dummy *dummy, const ENT_TickContext *ctx);
