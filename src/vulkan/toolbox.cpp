...
VkPipelineStageFlags2 vk_toolbox::getTransferPipelineStageFlags(VkImageLayout layout)
{
	switch (layout)
	{
...
VkAccessFlags2 vk_toolbox::getTransferAccessFlags(VkImageLayout layout)
{
	switch (layout)
	{
		case VK_IMAGE_LAYOUT_UNDEFINED:
		...
		case VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL:
			return VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
