...
void Texture::cleanUp()
{
	...
	{
		vkDestroyImageView(g_vulkanBackend->m_device, m_view, nullptr);
		m_view = VK_NULL_HANDLE;
	}
...
void Texture::createInternalResources()
{
	...
	switch (m_type)
	{
		...
		default:
			LLT_ERROR("[TEXTURE] Failed to find VkImageType given VkImageViewType: %d", m_type);
			break;
	}
...
// todo: this is literally the worst thing ever
