...
Currently there is only one "renderer", but in the future if 2D rendering is to be added, then I'll split it up into two seperate renderers. I've also got plans to add a debug renderer, for debug lines / spheres, etc...
